(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('whatwg-fetch'), require('graphql/language/printer'), require('redux'), require('graphql-anywhere'), require('symbol-observable'), require('apollo-link')) :
	typeof define === 'function' && define.amd ? define(['exports', 'whatwg-fetch', 'graphql/language/printer', 'redux', 'graphql-anywhere', 'symbol-observable', 'apollo-link'], factory) :
	(factory((global.apollo = {}),null,global.graphql_language_printer,global.Redux,global.graphqlAnywhere,global.$$observable,global.apolloLink));
}(this, (function (exports,whatwgFetch,graphql_language_printer,redux,graphqlAnywhere,$$observable,apolloLink) { 'use strict';
...
var QueryScheduler = (function () {
    ...
    QueryScheduler.prototype.checkInFlight = function (queryId) {
        ...
        return (queries.get(queryId) &&
            queries.get(queryId).networkStatus !== exports.NetworkStatus.ready);
    };
...
var ApolloClient$1 = (function () {
    function ApolloClient(options) {
        ...
        var createQuery = function (getResult) {
            var resolved = false;
            return function (request) { return new Promise(function (resolve, reject) {
        ...
        if (networkInterface instanceof apolloLink.ApolloLink) {
            this.networkInterface = {
                query: createQuery(function (request) {
                    return apolloLink.execute(networkInterface, request);
                }),
            };
        }
